...

{
  ...
  class Item {
    constructor(el) {
      ...
      this.DOM = { el: el }
      // the inner image
      this.DOM.image = this.DOM.el.getElementsByClassName(styles.item__img)[0]
  ...
  class SmoothScroll {
    constructor() {
      // the <main> element
      this.DOM = { main: document.getElementsByClassName("main")[0] }
      // the scrollable element
      // we translate this element when scrolling (y-axis)
      if (this.DOM.main !== undefined) {
        this.DOM.scrollable = this.DOM.main.querySelector("div[data-scroll]")
        // the items on the page
        this.items = []
        ;[
          ...this.DOM.main.getElementsByClassName(styles.imageAnimationItem),
    ...
    style() {
      ...
      // this.DOM.main.style.willChange = "transform"
    }
    initEvents() {
  ...
  const preloadImages = () => {
    return new Promise((resolve, reject) => {
      imagesLoaded(
        document.getElementsByClassName(styles.item__img),
        { background: true },
        resolve
      )
    })
