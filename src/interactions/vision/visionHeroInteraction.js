import { TweenMax, TimelineMax, Expo, Power1, Quint, gsap } from "gsap"
...
console.log('hello')
  ...
  class Image {
    ...
    isActive() {
      // check if image is animating or if it's visibleclear
  ...
  class ImageTrail {
    constructor() {
      ...
      this.DOM = { content: document.getElementsByClassName(styles.content)[0] }

      // array of Image objs, one per image element
      this.images = []
      ;[...document.getElementsByClassName(styles.content__img)].forEach(img =>
  ...
  const preloadImages = () => {
    return new Promise((resolve, reject) => {
      imagesLoaded(
        document.getElementsByClassName(styles.content__img),
        resolve
      )
    })
  }
