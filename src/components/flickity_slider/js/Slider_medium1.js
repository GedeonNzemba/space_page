...
class SliderMedium1 extends React.Component {
  constructor(props){
      super(props);
      this.state = {
  ...
  componentDidMount(){
    ...
    // Parallex For images
    var mainCarousel = document.querySelector('.main-carousel-md');    
    ...
    var imgs = mainCarousel.querySelectorAll('.carousel-image-md img');
    ...
    // Previous Button
    var flkty = new Flickity('.main-carousel-md');
  ...
  render(){
    return(
      <div className="main-carousel-md">
        <Helmet>
