...
class Slider extends React.Component {
  ...
  componentDidMount() {
    ...
    // Parallex For images
    var carousel = document.querySelector(".carousel-first")
    ...
    var imgs = carousel.querySelectorAll(".carousel-figure img")
    ...
    // Previous Button
    var flkty = new Flickity(".carousel-first")
    var previousButton_1 = document.querySelector(".button--previous-one")
    ...
    // Next Button
    var flkty = new Flickity(".carousel-first")
    var nextButton_1 = document.querySelector(".button--next-one")
    ...
    return (
      <div className="carousel-first">
        ...
        <div className="carousel-figure">
          <img
            src={this.state.typical_bachelor_unit_b_b}
            alt="typical bachelor unit A B"
          />
        </div>
        <div className="carousel-figure">
          <img
            src={this.state.typical_bachelor_unit_a_b}
            alt="typical bachelor unit B B"
          />
        </div>
        <div className="carousel-figure">
