...
class SliderFIVE extends React.Component {
  constructor(props){
      super(props);
      this.state = {
  ...
  componentDidMount(){
    ...
    // Parallex For images
    var mainCarousel_5 = document.querySelector('.main-carousel-5');    
    var flkty = new Flickity( mainCarousel_5, {
      imagesLoaded: true,
    ...
    var imgs = mainCarousel_5.querySelectorAll('.carousel-image--5 img');
    ...
    // Previous Button
    var flkty = new Flickity('.main-carousel-5');
    var previousButton = document.querySelector('.btn--previous_5');
    ...
    // Next Button
    var flkty = new Flickity('.main-carousel-5');
    var previousButton = document.querySelector('.btn--next_5');
    previousButton.addEventListener( 'click', function() {
      flkty.next();
    });
  }
