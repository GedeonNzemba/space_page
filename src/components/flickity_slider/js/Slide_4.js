...
class SliderFOUR extends React.Component {
  ...
  componentDidMount(){
    ...
    // Parallex For images
    var mainCarousel_4 = document.querySelector('.main-carousel-4');    
    var flkty = new Flickity( mainCarousel_4, {
      imagesLoaded: true,
    ...
    var imgs = mainCarousel_4.querySelectorAll('.carousel-image--4 img');
    ...
    // Previous Button
    var flkty = new Flickity('.main-carousel-4');
    var previousButton = document.querySelector('.btn--previous_4');
    ...
    // Next Button
    var flkty = new Flickity('.main-carousel-4');
    var previousButton = document.querySelector('.btn--next_4');
    previousButton.addEventListener( 'click', function() {
      flkty.next();
    });
  }
