...
class SliderTHREE extends React.Component {
  ...
  componentDidMount(){
    ...
    // Parallex For images
    var mainCarousel_3 = document.querySelector('.main-carousel-3');    
    var flkty = new Flickity( mainCarousel_3, {
      imagesLoaded: true,
    ...
    var imgs = mainCarousel_3.querySelectorAll('.carousel-image--3 img');
    ...
    // Previous Button
    var flkty = new Flickity('.main-carousel-3');
    var previousButton = document.querySelector('.btn--previous_3');
    ...
    // Next Button
    var flkty = new Flickity('.main-carousel-3');
    var previousButton = document.querySelector('.btn--next_3');
    previousButton.addEventListener( 'click', function() {
      flkty.next();
    });
  }
